 ...
 */
package njhk.wisdom.web.service.persistence.proxy;

import njhk.wisdom.web.bean.common.persistence.Page;
import njhk.wisdom.web.bean.common.utils.Reflections;
import njhk.wisdom.web.service.persistence.proxy.PaginationMapperMethod;
        ...
        if (result == null && method.getReturnType().isPrimitive()) {
            throw new BindingException(
                    "Mapper method '"
                            ...
                            + ") attempted to return null pojo a method with a primitive return type ("
