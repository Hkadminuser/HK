...
public class AddresController extends BaseController {
     ...
     * @return
     */
    @ApiOperation(value = "地址列表", notes = "地址列表", produces = "application/json", response = AddressVo.class)
            ...
            @ApiParam(required = false, name = "id", value = "用户id") @RequestParam(value = "id", required = false) String id)
    {
        ...
        Page<AddressVo> voObjectPage = new Page<AddressVo>(pageNo, pageSize);
        ...
        List<AddressVo> voObjectList = new ArrayList<AddressVo>();
        for (Address forObject : objectPage.getList()) {
            AddressVo voObject = new AddressVo();
     ...
     * @return
     */
    @ApiOperation(value = "增加地址", notes = "增加地址", produces = "application/json", response = Address.class)
     ...
     * @return
     */
    @ApiOperation(value = "删除地址", notes = "删除地址", produces = "application/json", response = Address.class)
