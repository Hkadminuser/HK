...
@Setter
@ToString
public class CustomerVo extends DataEntity<CustomerVo> {
    ...
    /*    @ApiModelProperty(value = "安康宝用户")
        private Set<AKBCustomer> akbcustomer = new HashSet<AKBCustomer>(0);
        @ApiModelProperty(value = "客户信息其他内容")
        private Set<EntityCustomer> entityCustomer = new HashSet<EntityCustomer>(0);
        @ApiModelProperty(value = "客户消费信息")
        private Set<FimiticCustomer> fimiticCustomer = new HashSet<FimiticCustomer>(
                0);
        @ApiModelProperty(value = "服务人员信息")
        private Set<ServePerson> servePersons = new HashSet<ServePerson>(0);
        @ApiModelProperty(value = "服务工单信息")
   ...
   /* private Set<CustomerSuggestion> suggestions = new HashSet<CustomerSuggestion>(
            0);

    private Set<CustomerAddress> addresses = new HashSet<CustomerAddress>(0);

    private Set<CustomerPrivilege> privileges = new HashSet<CustomerPrivilege>(
            0);

    private Set<CustomerPromotion> promotions = new HashSet<CustomerPromotion>(
            0);

    private Set<AttachInfo> attachment = new HashSet<AttachInfo>(0);*/
    //新增2017-01-05

    /*  private Set<CustomerReturnVisit> customerReturnVisits = new HashSet<CustomerReturnVisit>();*/
    ...
    /* @ApiModelProperty(value = "操作记录")
     private Set<CustomerOperation> customerOperations = new HashSet<CustomerOperation>();*/
