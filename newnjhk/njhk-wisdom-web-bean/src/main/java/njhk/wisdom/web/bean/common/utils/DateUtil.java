...
public class DateUtil {
	...
	* @author luguosui
	 ...
	 * @author luguosui
	 */
	public static boolean compareDate(Date strat, Date end) {
		if (strat == null || end == null) {
			return false;
		}
		return strat.getTime() >= end.getTime();
	}
	...
	*/
	...
	public static Date str2Date(String date,String parrent) {
		if (StringUtils.isNotBlank(date)) {
	 ...
	 * @param monthCount
	 */
	public static String getAfterTimes(int monthCount) {
